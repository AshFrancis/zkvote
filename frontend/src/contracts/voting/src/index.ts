...
export const networks = {
  futurenet: {
    ...
    contractId: "CCVQB4JRHQNKWULWLFK43T5EO5SAUS3THKLX63OHD2APEJQB4ZYL5EPF",
  }
} as const
...
export interface Client {
   ...
   * 
   * Nullifier domain separation expectation:
   * callers must derive `nullifier = H(secret, dao_id, proposal_id)` (and optionally vote choice)
   * to prevent reuse across DAOs/proposals. Storage keys include `(dao_id, proposal_id, nullifier)`
   * to enforce per-proposal uniqueness on-chain.
   */
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "",
        ...
        "",
