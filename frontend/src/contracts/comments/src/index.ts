...
export const networks = {
  futurenet: {
    ...
    contractId: "CCVZBBWWZQ2NBQL4ZAF5U7Y6LQ6WA5QLKCEI4ZHPVSWS7SGJ7VNK3ZNV",
  }
} as const
...
export class Client extends ContractClient {
  static async deploy<T = Client>(
        ...
        {tree_contract, voting_contract}: {tree_contract: string, voting_contract: string},
    ...
    return ContractClient.deploy({tree_contract, voting_contract}, options)
  }
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAQAAAA1Hcm90aDE2IFByb29mAAAAAAAAAAAAAAVQcm9vZgAAAAAAAAMAAAAAAAAAAWEAAAAAAAPuAAAAQAAAAAAAAAABYgAAAAAAA+4AAACAAAAAAAAAAAFjAAAAAAAD7gAAAEA=",
        ...
        "",
        ...
        "AAAAAAAAAFJDb25zdHJ1Y3RvcjogSW5pdGlhbGl6ZSBjb250cmFjdCB3aXRoIE1lbWJlcnNoaXBUcmVlIGFuZCBWb3RpbmcgY29udHJhY3QgYWRkcmVzc2VzAAAAAAANX19jb25zdHJ1Y3RvcgAAAAAAAAIAAAAAAAAADXRyZWVfY29udHJhY3QAAAAAAAATAAAAAAAAAA92b3RpbmdfY29udHJhY3QAAAAAEwAAAAA=",
